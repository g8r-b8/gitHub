...
//Makes JUnit (annotations etc.) work
...
public class TestOperations {
	...
	public void testSubtract(){
		...
		assertTrue(result == 2);
		result = Operations.subtract(maxValue, 1);
		assertEquals(result, maxValue-1);
		assertFalse((Operations.subtract(maxValue, 1)) < 0);
		System.out.println("Result testSubtract: " + result);
	}
